#' @noRd
#'
PrInDTstruc2 <- function(data,class,ctestv=NA,name,check,labs,N,Ni=NA,Pit,Eit,undersamp=TRUE,co,crit="ba",ktest=0,stest=integer(length=0),p1,p2,minsplit=20,minbucket=7,valdat){
# if (anyNA(Struc[[1]]) != TRUE){
#  name <- Struc$name
#  check <- eval(parse(text = Struc$check))  ## NEWNEW
#  labs <- Struc$labs
# }
